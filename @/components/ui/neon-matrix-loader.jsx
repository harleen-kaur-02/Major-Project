  ...
  return (
    <div className='flex flex-col items-center justify-center gap-6 p-8'>
        ...
        <div className='grid grid-cols-3 gap-2 w-full h-full'>
          {[...Array(9)].map((_, index) => (
            <div
              ...
              <div
                className='w-full h-full rounded-md bg-gradient-to-br from-cyan-500 via-blue-500 to-indigo-500 shadow-lg shadow-blue-500/50' />
            </div>
          ))}
        </div>
      ...
      <div className='flex flex-col items-center gap-2'>
        <p
          className='text-sm font-semibold bg-gradient-to-r from-cyan-500 via-blue-500 to-indigo-500 bg-clip-text text-transparent animate-pulse'>
          Loading
        </p>
